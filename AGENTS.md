...
It runs Telegram and/or Matrix, can expose an optional direct WebSocket API, keeps state under `~/.phoenix-patchbay`, and supervises the main agent plus optional sub-agents in one asyncio process.
