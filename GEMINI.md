...
patchbay is a multi-transport chat orchestrator for the official provider CLIs (`claude`, `codex`, `gemini`, `agy`).
...
- Skill sync spans `~/.phoenix-patchbay/workspace/skills`, `~/.claude/skills`, `~/.codex/skills`, `~/.gemini/skills`:
