...
- `~/.phoenix-patchbay/workspace/api_files/YYYY-MM-DD/...`
...
- `workspace` -> `~/.phoenix-patchbay/workspace` limited

MIME and file-tag parsing share helpers from `phoenix_patchbay/files/`.
