...
- `/start`, `/help`, `/info`, `/files`, `/stop`, `/stop_all`, `/restart`, `/new`, `/reset`, `/session`, `/sessions`, `/tasks`, `/agent_commands`
...
`ChatTracker` stores activity in `~/.phoenix-patchbay/chat_activity.json`.
