...
- `~/.phoenix-patchbay/workspace/telegram_files/` (Telegram media)
- `~/.phoenix-patchbay/workspace/matrix_files/` (Matrix media)
- `~/.phoenix-patchbay/workspace/output_to_user/`
- `~/.phoenix-patchbay/workspace/api_files/`
