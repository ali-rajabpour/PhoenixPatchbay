...
- `config.transcription.audio_command` is exported to CLI subprocesses as `PATCHBAY_TRANSCRIBE_COMMAND`
- `config.transcription.video_command` is exported as `PATCHBAY_VIDEO_TRANSCRIBE_COMMAND`
...
- Telegram uploads: `~/.phoenix-patchbay/workspace/telegram_files/YYYY-MM-DD/`
- Matrix uploads: `~/.phoenix-patchbay/workspace/matrix_files/YYYY-MM-DD/`
- API uploads: `~/.phoenix-patchbay/workspace/api_files/YYYY-MM-DD/`
