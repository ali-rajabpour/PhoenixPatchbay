...
State files under `~/.phoenix-patchbay/`:
...
- macOS/Windows: file tail from `~/.phoenix-patchbay/logs/agent.log` (fallback newest `*.log`)
...
Centralised loading of user-defined API secrets from `~/.phoenix-patchbay/.env`.
