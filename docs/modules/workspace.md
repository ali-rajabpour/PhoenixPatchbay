...
Workspace/home-directory management for `~/.phoenix-patchbay`.

## Files

- `paths.py`: immutable `PatchbayPaths` + `resolve_paths()`
...
- `patchbay_home`: `~/.phoenix-patchbay` (default)
- `workspace`: `~/.phoenix-patchbay/workspace`
- `config_path`: `~/.phoenix-patchbay/config/config.json`
- `sessions_path`: `~/.phoenix-patchbay/sessions.json`
- `named_sessions_path`: `~/.phoenix-patchbay/named_sessions.json`
- `env_file`: `~/.phoenix-patchbay/.env`
- `tasks_registry_path`: `~/.phoenix-patchbay/tasks.json`
- `chat_activity_path`: `~/.phoenix-patchbay/chat_activity.json`
- `startup_state_path`: `~/.phoenix-patchbay/startup_state.json`
- `inflight_turns_path`: `~/.phoenix-patchbay/inflight_turns.json`
- `cron_jobs_path`: `~/.phoenix-patchbay/cron_jobs.json`
- `webhooks_path`: `~/.phoenix-patchbay/webhooks.json`
- `logs_dir`: `~/.phoenix-patchbay/logs`
- `cron_tasks_dir`: `~/.phoenix-patchbay/workspace/cron_tasks`
- `tasks_dir`: `~/.phoenix-patchbay/workspace/tasks`
- `api_files_dir`: `~/.phoenix-patchbay/workspace/api_files`
- `skills_dir`: `~/.phoenix-patchbay/workspace/skills`
...
- sub-agent homes do not create `logs/` by default; all agents write to the main home log file `~/.phoenix-patchbay/logs/agent.log`.
...
- Docker mode notice (`/patchbay` mount)
...
- `~/.phoenix-patchbay/workspace/skills`
- `~/.claude/skills`
- `~/.codex/skills`
- `~/.gemini/skills`
- `~/.grok/skills` (or `$GROK_HOME/skills`)

Default mode uses symlinks/junctions. Docker mode uses managed directory copies (`.phoenix-patchbay_managed`) so paths resolve inside container namespace.
