...
This is the top-level `~/.phoenix-patchbay` directory.
...
- `~/.phoenix-patchbay/agents.json` is the single source of truth for all sub-agent
...
`~/.phoenix-patchbay/SHAREDMEMORY.md` contains facts shared across all agents
