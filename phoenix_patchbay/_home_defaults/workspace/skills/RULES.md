...
This directory is part of patchbay's three-way skill sync.
...
- Priority when duplicates exist: `patchbay > claude > codex`.
- Real directories are never overwritten.
- Broken patchbay-managed links are cleaned automatically.
