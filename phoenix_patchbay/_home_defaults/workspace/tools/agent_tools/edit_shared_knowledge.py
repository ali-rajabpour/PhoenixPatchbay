...
def _shared_path() -> Path:
    ...
    Priority:
    1. PATCHBAY_SHARED_MEMORY_PATH env var (set by framework)
    2. PATCHBAY_HOME / SHAREDMEMORY.md (works for main agent)
    3. Navigate up from sub-agent home: agents/<name>/ -> ../../SHAREDMEMORY.md
    """
    env_path = os.environ.get("PATCHBAY_SHARED_MEMORY_PATH")
    if env_path:
    ...
    # Sub-agent: home is ~/.phoenix-patchbay/agents/<name>/, shared is at ~/.phoenix-patchbay/SHAREDMEMORY.md
