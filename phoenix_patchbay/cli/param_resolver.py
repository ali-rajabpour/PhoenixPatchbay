...
def _resolve_reasoning_effort(
    ...
    providers drop it. An explicit, unsupported override raises PatchbayError.
    """
...
def resolve_cli_config(
    ...
    *,
    ...
    Raises:
        PatchbayError: If model validation fails
    """
    ...
    if provider == "claude":
        ...
        from phoenix_patchbay.config import get_grok_models
    ...
    return CLIRunConfig(
        ...
        working_dir=base_config.patchbay_home,
