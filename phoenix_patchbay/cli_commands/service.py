"""Service management CLI subcommands (``patchbay service ...``)."""
...
def print_service_help() -> None:
    ...
    table.add_column()
    table.add_row("patchbay service install", "Install and start background service")
    table.add_row("patchbay service status", "Show service status")
    table.add_row("patchbay service start", "Start the service")
    table.add_row("patchbay service stop", "Stop the service")
    table.add_row("patchbay service logs", "View live logs")
    table.add_row("patchbay service uninstall", "Remove the service")
    _console.print(
...
def cmd_service(args: list[str]) -> None:
    """Handle 'patchbay service <subcommand>'."""
