"""Internationalization module for patchbay-bot.

Public API::

    from phoenix_patchbay.i18n import init, t, t_rich, t_cmd, t_plural
...
from phoenix_patchbay.i18n.loader import TranslationStore
