...
Usage:
    python -m phoenix_patchbay.i18n.check
    python -m phoenix_patchbay.i18n.check --root /path/to/i18n
    python -m phoenix_patchbay.i18n.check --quiet  # exit-code only, no output
...
from phoenix_patchbay.i18n import LANGUAGES
from phoenix_patchbay.i18n.loader import _load_toml
...
def main(argv: list[str] | None = None, out: TextIO | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m phoenix_patchbay.i18n.check",
    ...
    parser.add_argument(
        ...
        help="Directory containing per-locale subfolders (default: phoenix_patchbay/i18n).",
    )
    parser.add_argument(
        "--quiet",
        action="store_true",
