"""Platform-dispatching service management for patchbay.
...
if sys.platform == "win32":
    from phoenix_patchbay.infra import service_windows as _backend
elif sys.platform == "darwin":
    from phoenix_patchbay.infra import service_macos as _backend
else:
    from phoenix_patchbay.infra import service_linux as _backend
...
def install_service(console: Console | None = None) -> bool:
    """Install and start the patchbay background service. Returns True on success."""
    return _backend.install_service(console)


def uninstall_service(console: Console | None = None) -> bool:
    """Stop and remove the patchbay background service."""
