...
def find_patchbay_binary() -> str | None:
    """Find the patchbay binary in PATH. Shared across all backends."""
    return shutil.which("patchbay")
...
def print_binary_not_found(console: Console) -> None:
    """Print the 'patchbay binary not found' error."""
...
def print_install_success(
    ...
    *logs_hint* is the description next to ``patchbay service logs``.
    """
    console.print(
        Panel(
