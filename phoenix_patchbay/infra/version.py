...
_PYPI_URL = "https://pypi.org/pypi/patchbay/json"
_GITHUB_RELEASES_URL = "https://api.github.com/repos/ali-rajabpour/PhoenixPatchbay/releases"
_PACKAGE_NAME = "patchbay"
_TIMEOUT = aiohttp.ClientTimeout(total=10)


def get_current_version() -> str:
    """Return the installed version of patchbay."""
    try:
