...
from phoenix_patchbay.messenger.slack.id_map import SlackIdMap
from phoenix_patchbay.messenger.slack.sender import SlackSendOpts, send_rich
...
def _restart_marker_path(patchbay_home: str) -> Path:
...
class SlackBot:
        ...
        *,
        ...
        if not _SLACK_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install 'patchbay[slack]'"
            ) from None

        self._config = config
        self._agent_name = agent_name
        self._store_path = Path(config.patchbay_home).expanduser() / "slack_store"
        ...
        from phoenix_patchbay.messenger.slack.transport import SlackTransport
    ...
    async def run(self) -> int:
        ...
        from phoenix_patchbay.messenger.slack.startup import run_slack_startup
    ...
    async def _run_streaming(
        ...
        *,
        ...
        from phoenix_patchbay.messenger.slack.streaming import SlackStreamEditor
    ...
    async def _cmd_restart(
        ...
        *,
        ...
        marker = _restart_marker_path(self._config.patchbay_home)
    ...
    async def on_async_interagent_result(self, result: AsyncInterAgentResult) -> None:
        from phoenix_patchbay.bus.adapters import from_interagent_result
