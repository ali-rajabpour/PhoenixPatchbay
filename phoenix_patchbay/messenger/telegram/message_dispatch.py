...
from phoenix_patchbay.cli.coalescer import CoalesceConfig, StreamCoalescer
from phoenix_patchbay.messenger.telegram.sender import (
    SendRichOpts,
    send_files_from_text,
    send_rich,
)
from phoenix_patchbay.messenger.telegram.stop_button import stop_markup
from phoenix_patchbay.messenger.telegram.streaming import StreamEditor, create_stream_editor
...
if TYPE_CHECKING:
    ...
    from phoenix_patchbay.config import SceneConfig, StreamingConfig
