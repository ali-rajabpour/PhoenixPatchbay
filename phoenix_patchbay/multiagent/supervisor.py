...
from phoenix_patchbay.config import AgentConfig, update_config_file_async
from phoenix_patchbay.infra.file_watcher import FileWatcher
from phoenix_patchbay.infra.restart import EXIT_RESTART
from phoenix_patchbay.multiagent.health import AgentHealth
from phoenix_patchbay.multiagent.models import SubAgentConfig, merge_sub_agent_config
from phoenix_patchbay.multiagent.registry import AgentRegistry
from phoenix_patchbay.multiagent.stack import AgentStack
from phoenix_patchbay.workspace.paths import resolve_paths

if TYPE_CHECKING:
    from phoenix_patchbay.multiagent.bus import InterAgentBus
    from phoenix_patchbay.multiagent.internal_api import InternalAgentAPI
    from phoenix_patchbay.multiagent.shared_knowledge import SharedKnowledgeSync
...
class AgentSupervisor:
    ...
    def __init__(self, main_config: AgentConfig) -> None:
        ...
        self._main_paths = resolve_paths(patchbay_home=main_config.patchbay_home)
        self._agents_path = self._main_paths.patchbay_home / "agents.json"
    ...
    async def start(self) -> int:
        ...
        if self._main_config.docker.enabled and self._main_config.docker.extras:
            from phoenix_patchbay.infra.docker_extras import calculate_build_timeout, resolve_extras
        ...
        shared_path = self._main_paths.patchbay_home / "SHAREDMEMORY.md"
    ...
    async def _start_sub_agent(self, sub_cfg: SubAgentConfig) -> None:
        ...
        agent_home = self._main_paths.patchbay_home / "agents" / name
