...
from phoenix_patchbay.multiagent.registry import update_agent_fields
...
async def switch_model(
    ...
    *,
    ...
    if not is_topic:
        ...
        if orch.paths.patchbay_home.parent.name == "agents":
            agents_path = orch.paths.patchbay_home.parent.parent / "agents.json"
