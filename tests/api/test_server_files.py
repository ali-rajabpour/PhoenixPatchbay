...
pytest.importorskip("nacl", reason="PyNaCl not installed (optional: pip install patchbay[api])")

from aiohttp import FormData, web

from phoenix_patchbay.api.server import _parse_file_refs
...
class TestFileUpload:
    ...
    def test_uploaded_file_exists_on_disk(self, tmp_path: Path) -> None:
        ...
        from phoenix_patchbay.files.storage import prepare_destination
