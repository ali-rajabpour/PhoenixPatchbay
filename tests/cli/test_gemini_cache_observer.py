...
from phoenix_patchbay.cli.gemini_cache import GeminiModelCache
...
class TestGeminiCacheObserver:
    ...
    async def test_observer_loads_cache_at_start(self, tmp_path: Path) -> None:
        ...
        with patch(
            "phoenix_patchbay.cli.gemini_cache_observer.GeminiModelCache.load_or_refresh",
    ...
    async def test_observer_verifies_60_minute_interval(self) -> None:
        ...
        from phoenix_patchbay.cli.model_cache import REFRESH_INTERVAL_S
