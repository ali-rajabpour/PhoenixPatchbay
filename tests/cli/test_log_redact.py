...
from phoenix_patchbay.cli.antigravity_provider import _safe_command_for_logging
from phoenix_patchbay.cli.claude_provider import _log_cmd as log_claude_cmd
from phoenix_patchbay.cli.codex_provider import _log_cmd as log_codex_cmd
from phoenix_patchbay.cli.gemini_provider import _log_cmd as log_gemini_cmd
...
def test_redact_cmd_for_log_masks_secret_and_preserves_structure() -> None:
    ...
    assert "PATCHBAY_CHAT_ID=42" in rendered
