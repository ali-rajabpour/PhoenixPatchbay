...
from phoenix_patchbay.cron.execution import build_cmd
...
class TestBuildCmdWithTaskExecutionConfig:
    ...
    def test_build_cmd_codex_basic(self) -> None:
        ...
        with patch("phoenix_patchbay.cron.execution.which", return_value="/usr/bin/codex"):
            result = build_cmd(exec_config, "hello world")
    ...
    def test_build_cmd_gemini_emits_no_effort(self) -> None:
        ...
        with patch("phoenix_patchbay.cron.execution.find_gemini_cli", return_value="/usr/bin/gemini"):
            result = build_cmd(exec_config, "task")
    ...
    def test_build_cmd_cli_not_found(self) -> None:
        ...
        with patch("phoenix_patchbay.cron.execution.which", return_value=None):
            result = build_cmd(exec_config, "test")
...
class TestResolveToBuildEffortFlow:
    ...
    def test_gemini_drops_effort(self) -> None:
        from phoenix_patchbay.cli.param_resolver import RunOverrides, resolve_cli_config
        from phoenix_patchbay.config import set_gemini_models
