"""Tests for the i18n completeness checker (phoenix_patchbay.i18n.check)."""
...
from phoenix_patchbay.i18n.check import (
    DomainReport,
    LocaleReport,
    Report,
    _compare_domain,
...
def test_main_returns_one_on_gaps(tmp_path: Path) -> None:
    _write_locale(tmp_path, "en", {"chat": 'a = "x"\nb = "y"'})
    _write_locale(tmp_path, "de", {"chat": 'a = "x"'})
    # Trick: phoenix_patchbay.i18n.LANGUAGES has many locales; use --root and rely on
