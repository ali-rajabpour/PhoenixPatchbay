...
def _make_bot(
    *,
    ...
    """
    from phoenix_patchbay.messenger.matrix import bot as bot_module
...
async def test_matrix_startup_wires_notify_upgrade_on_update(
    ...
    from phoenix_patchbay.messenger.matrix import startup as startup_module
    ...
    import phoenix_patchbay.infra.install as install_mod
    import phoenix_patchbay.infra.updater as updater_mod
    ...
    import phoenix_patchbay.orchestrator.core as core_mod
