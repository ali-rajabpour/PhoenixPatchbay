...
from phoenix_patchbay.messenger.slack.bot import SlackBot, _ThreadContextCache
...
class TestMentionedThreadCache:
    def test_prunes_expired_entries(self) -> None:
        ...
        with patch("phoenix_patchbay.messenger.slack.bot.time") as mock_time:
...
class TestMessageRouting:
    ...
    async def test_run_streaming_falls_back_when_native_streaming_fails(self) -> None:
        ...
        with patch(
            "phoenix_patchbay.messenger.slack.streaming.send_rich",
