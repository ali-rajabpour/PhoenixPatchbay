...
class TestHandleAbort:
    ...
    async def test_abort_kills_processes_and_replies(self) -> None:
        from phoenix_patchbay.messenger.telegram.handlers import handle_abort
    ...
    async def test_abort_zero_killed_sends_nothing_text(self) -> None:
        ...
        with patch(
            "phoenix_patchbay.messenger.telegram.handlers.send_rich",
...
class TestHandleAbortAll:
    ...
    async def test_abort_all_kills_local_and_callback(self) -> None:
        from phoenix_patchbay.messenger.telegram.handlers import handle_abort_all
...
class TestHandleCommand:
    ...
    async def test_command_routes_to_orchestrator(self) -> None:
        from phoenix_patchbay.messenger.telegram.handlers import handle_command
...
class TestStripMention:
    ...
    def test_removes_mention(self) -> None:
        from phoenix_patchbay.messenger.telegram.handlers import strip_mention
...
class TestBuildReplyPrompt:
    ...
    def test_quote_fragment_preferred(self) -> None:
        from phoenix_patchbay.messenger.telegram.handlers import build_reply_prompt
...
class TestPrependReplyToMedia:
    ...
    def test_prefixes_quote_and_labels_voice(self) -> None:
        from phoenix_patchbay.messenger.telegram.handlers import prepend_reply_to_media
...
class TestForumTopicPropagation:
    ...
    @patch("phoenix_patchbay.messenger.telegram.handlers.send_rich", new_callable=AsyncMock)
