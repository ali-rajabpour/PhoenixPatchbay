...
async def test_non_streaming_reacts_on_trigger_message_not_reply_to() -> None:
    ...
    with (
        patch(
            "phoenix_patchbay.messenger.telegram.message_dispatch.send_rich",
            new_callable=AsyncMock,
        ),
        patch("phoenix_patchbay.messenger.telegram.message_dispatch.TypingContext") as typing_ctx,
    ):
...
async def test_streaming_reasoning_only_still_sends_final_answer() -> None:
    ...
    from phoenix_patchbay.config import StreamingConfig
    ...
    with (
        patch(
            "phoenix_patchbay.messenger.telegram.message_dispatch.create_stream_editor",
            return_value=editor,
        ),
        patch(
            "phoenix_patchbay.messenger.telegram.message_dispatch.send_rich",
        ...
        patch(
            "phoenix_patchbay.messenger.telegram.message_dispatch.send_files_from_text",
            new_callable=AsyncMock,
        ) as send_files_mock,
        patch("phoenix_patchbay.messenger.telegram.message_dispatch.TypingContext") as typing_ctx,
    ):
