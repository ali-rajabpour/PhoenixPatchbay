...
class TestAuthMiddleware:
    ...
    async def test_allowed_user_passes(self) -> None:
        from phoenix_patchbay.messenger.telegram.middleware import AuthMiddleware
...
class TestIsQuickCommand:
    ...
    def test_is_quick_command(self, text: str, expected: bool) -> None:
        from phoenix_patchbay.messenger.telegram.middleware import is_quick_command
...
class TestQueueManagement:
    ...
    async def test_cancel_entry_marks_cancelled(self) -> None:
        from phoenix_patchbay.messenger.telegram.middleware import SequentialMiddleware, _QueueEntry
