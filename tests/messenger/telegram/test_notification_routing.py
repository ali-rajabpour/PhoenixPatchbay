...
from phoenix_patchbay.config import AgentConfig, NotificationsConfig, NotificationTarget
from phoenix_patchbay.messenger.telegram.sender import SendRichOpts
...
def _make_bot(
    ...
    *,
    ...
    """
    from phoenix_patchbay.messenger.telegram import app as app_module
