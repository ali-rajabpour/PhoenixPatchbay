...
from phoenix_patchbay.messenger.notifications import CompositeNotificationService
...
class TestMultiBotAdapterCreation:
    def test_creates_correct_number_of_bots(self) -> None:
        ...
        with patch(
            "phoenix_patchbay.messenger.registry._create_single_bot",
...
class TestRegistryMultiTransport:
    def test_single_transport_returns_single_bot(self) -> None:
        ...
        with patch(
            "phoenix_patchbay.messenger.telegram.app.TelegramBot",
