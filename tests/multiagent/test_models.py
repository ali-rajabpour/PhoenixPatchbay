...
from phoenix_patchbay.config import AgentConfig, ApiConfig
...
class TestSubAgentConfig:
    ...
    def test_with_overrides(self) -> None:
        ...
        assert cfg.allowed_user_ids == [100]
...
class TestMergeSubAgentConfig:
    ...
    def test_patchbay_home_always_set_to_agent_home(self) -> None:
        """patchbay_home is always the agent's home dir, not main's."""
        main = self._main_config()
        sub = SubAgentConfig(name="sub1", telegram_token="sub-token")
        result = merge_sub_agent_config(main, sub, Path("/agents/sub1"))

        assert result.patchbay_home == "/agents/sub1"
    ...
    def test_allowed_user_ids_from_sub(self) -> None:
        ...
        assert result.allowed_user_ids == [100]
    ...
    def test_allowed_user_ids_none_does_not_inherit_main(self) -> None:
        ...
        """
        main = self._main_config()
        assert main.allowed_user_ids == [1]
